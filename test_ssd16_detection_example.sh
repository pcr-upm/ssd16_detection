...
rsync --delete -azvv /var/lib/docker/volumes/ssd16_detection_volume/_data/conda/envs/ssd16/lib/python3.8/site-packages/images_framework/output/images/ output
